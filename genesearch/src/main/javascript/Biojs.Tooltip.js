...
/** @lends Biojs.Tooltip# */
{
  ...
  */
  ...
  _initialize: function( ) {
      ...
      if ( this.opt.targetSelector instanceof jQuery ) {
         targetSelector = this.opt.targetSelector;
      } else {
         targetSelector = jQuery( this.opt.targetSelector );
      }
      ...
      if ( refPos == Biojs.Tooltip.MOUSE_POSITION ) {
    	  targetSelector.mousemove( function (e) {
              ...
              // Set the content
              content = cbRender.call( self, e.target, self._body );
    	  ...
    	  targetSelector.mouseenter( function (e) {
  ...
  _show: function() {
	  ...
	  this.raiseEvent( Biojs.Tooltip.EVT_ON_SHOW_UP, {} );
  },
  ...
  /**
   * Sets the content of this tip.
   * 
   * @param {string|HTMLElement} content Content to be setted.
   * 
   * @example 
   * simpleTip.setContent("Content as HTML string");
   * 
   */
  ...
  /**
   * Gets the content element of this tip.
   * 
   * @return {HTMLElement} content Element which contains the content.
   * 
   * @example 
   * simpleTip.getContent("Content as HTML string");
   * 
   */
  getContent: function () {
	  this._body.children();
  ...
  /**
   * Returns the div element of the body.
   * @param {HTMLElement} body Container of the tip' body
   * 
   * @example 
   * tipRendered.getBodyContainer();
   * 
   */
