 ...
 * 
 * @requires <a href='../biojs/css/biojs.Table.css'>Table CSS</a>
 * @dependency <link href="../biojs/css/biojs.Table.css" rel="stylesheet" type="text/css" />
 * 
 * @requires <a href='../biojs/css/smoothness/jquery-ui-1.8.18.custom.css'>jquery-ui-1.8.18 CSS</a>
 ...
 *    
 * @option {bool} [showColumnSelector=true]
 *    Show/Hide column selection combo box.
 * 
 * @example 
...
/** @lends Biojs.Table# */
{
	constructor: function (options) {
		...
		self._container = jQuery( '#' + this.opt.target ).addClass("Table");

		self._table = jQuery('<table id="'+ self._tableId +'"></table>')
	...
	eventTypes: [
     ...
     /**
      * @name Biojs.Table#onCellMouseover
      * @event
      * @param {function} actionPerformed A function which receives a {@link Biojs.Event} object as argument.
      * @eventData {Object} source The component which triggered the event.
      * @eventData {int} rowIndex Row selected (0-based index).
      ...
      * @eventData {HTMLTableCellElement} cell Instance of the DOM HTMLTableCellElement selected.
      * @example
      * myTable.onCellMouseover(
      *    function( e ) {
      *       alert("Cell over row "+ e.rowIndex +", column " + e.colIndex + ". Value: " + e.cell.innerText );
      *    }
      * );
      *
      **/
     ...
     /**
      * @name Biojs.Table#onCellMouseenter
      * @event
      * @param {function} actionPerformed A function which receives a {@link Biojs.Event} object as argument.
      * @eventData {Object} source The component which triggered the event.
      * @eventData {int} rowIndex Row selected (0-based index).
      ...
      * @eventData {HTMLTableCellElement} cell Instance of the DOM HTMLTableCellElement selected.
      * @example
      * myTable.onCellMouseenter(
      *    function( e ) {
      *       alert("Mouse enter in row "+ e.rowIndex +", column " + e.colIndex + ". Value: " + e.cell.innerText );
      *    }
      * );
      *
      **/
     ...
     /**
      * @name Biojs.Table#onCellMouseout
      * @event
      * @param {function} actionPerformed A function which receives a {@link Biojs.Event} object as argument.
      * @eventData {Object} source The component which triggered the event.
      * @eventData {int} rowIndex Row selected (0-based index).
     ...
     setDataSource: function ( dataSet ) {
    	...
    	if ( this.opt.showColumnSelector ) {
     ...
     _initSettings: function( settings ) {
    	 ...
    	 if (this.opt.rowSelection) { 
    		 var columnsToHide = this.opt.hideColumns;
    	 ...
    	 settings.fnRowCallback = function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) { 
    		 self.raiseEvent(Biojs.Table.EVT_ON_ROW_RENDERED, {
    			 node: nRow,
    			 data: aData,
    			 index: iDisplayIndex
    		 });
     ...
     _initSettingsForLocalData: function( settings ) {
    	 ...
    	 // Enable filtering
    	 settings.bFilter = this.opt.filter;
     },
     ...
     _addEvents: function(){
    	 ...
    	 // Cell clicked 
    	 jQuery(this._tableSelector).children('td')
	    	 ...
	    	 .mouseover(function(e){
	    		 ...
	    		 self.raiseEvent( Biojs.Table.EVT_ON_CELL_MOUSEOVER, { 
    				 "cell": cell,
    				 "rowIndex": row,
    				 "colIndex": column 
    			 }); 
	    	 ...
	    	 .mouseenter(function(e){
	    		 ...
	    		 self.raiseEvent( Biojs.Table.EVT_ON_CELL_MOUSEENTER, { 
    				 "cell": cell,
    				 "rowIndex": row,
    				 "colIndex": column 
    			 });
	    	 ...
	    	 .mouseout(function(e){
	    		 ...
	    		 self.raiseEvent( Biojs.Table.EVT_ON_CELL_MOUSEOUT, { 
					 "cell": cell,
					 "rowIndex": row,
					 "colIndex": column 
				 });
...
/** @lends Biojs.Table */
{
	...
	EVT_ON_CELL_MOUSEOVER: "onCellMouseover",
	EVT_ON_CELL_MOUSEENTER: "onCellMouseenter",
	EVT_ON_CELL_MOUSEOUT: "onCellMouseout",
	EVT_ON_ROW_SELECTED:   "onRowSelected",
	EVT_ON_HEADER_CLICKED: "onHeaderClicked",
	EVT_ON_DATA_ARRIVED:   "onDataArrived",
	EVT_ON_ROW_RENDERED: "onRowRendered"
}
